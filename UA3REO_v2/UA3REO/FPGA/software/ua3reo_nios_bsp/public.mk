...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nios.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x12068
SOPC_SYSID_FLAG += --sidp=0x12068
ELF_PATCH_FLAG  += --sidp 0x12068

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1523556530
SOPC_SYSID_FLAG += --timestamp=1523556530
ELF_PATCH_FLAG  += --timestamp 1523556530
