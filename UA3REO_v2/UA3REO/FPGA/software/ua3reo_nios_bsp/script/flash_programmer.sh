...
#
nios2-flash-programmer "../flash/UA3REO_epcs_flash_controller_0.flash" --base=0x11000 --epcs --sidp=0x12068 --id=0x12345678 --timestamp=1523350539 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-1]' --program 
...
#
nios2-flash-programmer "../flash/ua3reo_nios_epcs_flash_controller_0.flash" --base=0x11000 --epcs --sidp=0x12068 --id=0x12345678 --timestamp=1523350539 --device=1 --instance=0 '--cable=USB-Blaster on localhost [USB-1]' --program 
